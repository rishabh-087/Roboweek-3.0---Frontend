const Footer = () => {
  return (
    <footer className="backdrop-blur-lg bg-black/20 border-t border-cyan-500/30 text-white z-10">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="backdrop-blur-lg bg-black/10 p-6 rounded-xl border border-cyan-500/30">
          ...
          <div className="backdrop-blur-lg bg-black/10 p-6 rounded-xl border border-cyan-500/30">
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li><a href="/events" className="text-gray-300 hover:text-cyan-400 transition-colors duration-300">Events</a></li>
              <li><a href="/team" className="text-gray-300 hover:text-cyan-400 transition-colors duration-300">Team</a></li>
              <li><a href="/sponsors" className="text-gray-300 hover:text-cyan-400 transition-colors duration-300">Sponsors</a></li>
            </ul>
          </div>
          <div className="backdrop-blur-lg bg-black/10 p-6 rounded-xl border border-cyan-500/30">
