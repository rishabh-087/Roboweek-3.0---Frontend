    ...
    >
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <article className="card backdrop-blur-lg bg-black/10 p-6 rounded-xl border border-cyan-500/30">
          ...
          <nav className="card backdrop-blur-lg bg-black/10 p-6 rounded-xl border border-cyan-500/30">
