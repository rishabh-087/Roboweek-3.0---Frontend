        ...
        <div className="grid gap-8">
          {events.map((event, index) => (
            <motion.div
              ...
              className="backdrop-blur-lg bg-black/20 rounded-xl border border-cyan-500 shadow-lg hover:border-cyan-500 transition-all duration-300 cursor-pointer"
            >
              <div className="p-8">
          ...
          {selectedEvent && (
            ...
            >
              <motion.div
                ...
                className="bg-black/90 border border-cyan-500/30 rounded-xl p-8 max-w-2xl w-full max-h-[80vh] overflow-y-auto"
              >
                <h2 className="text-3xl font-bold text-cyan-400 mb-4">{selectedEvent.title}</h2>
                <div className="space-y-6">
                  <div>
                    <h3 className="text-xl font-semibold text-white mb-2">Event Details</h3>
                    <div className="grid grid-cols-2 gap-4">
                      <div className="text-gray-300">
                        <p><span className="text-cyan-400">Date:</span> {selectedEvent.date}</p>
                        <p><span className="text-cyan-400">Venue:</span> {selectedEvent.details.venue}</p>
                        <p><span className="text-cyan-400">Time:</span> {selectedEvent.details.time}</p>
                        {selectedEvent.details.prize && (
                          <p><span className="text-cyan-400">Prize Pool:</span> {selectedEvent.details.prize}</p>
                        )}
                      </div>
                    </div>
                  </div>
